...
$config['email_forgot_password_complete'] = 'new_password.tpl.php';
	...
	|-----------------------------------------------------------------------
	*/
	$config['use_mandrill'] 					= 	true;
	$config['mandrill_api_key'] 				= 	'Bot9859OlLQ6F8nodcTunA';
	$config['mandrill_activation_template'] 	= 	'the-great-british-raffle-activation-v2';
	$config['mandrill_forgot_template'] 		= 	'the-great-british-raffle-forgot-password';
	$config['mandrill_activation_url']			=	base_url('activate');
	$config['mandrill_activation_fail_url']		=	base_url('activation');
	$config['mandrill_forgot_url']				=	base_url('login');
	$config['mandrill_forgot_fail_url']			=	base_url('forgot-password');
